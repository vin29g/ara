    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
        <ul class="nav navbar-nav navbar-right">
          <li <?php echo ($current_page=="home" ? 'class="active"':'')?> ><a href="<?=base_url()?>">Home</a></li>
          <li <?php echo ($current_page=="about" ? 'class="active"':'')?> ><a href="<?=base_url()?>">About</a></li>
          <li <?php echo ($current_page=="faq" ? 'class="active"':'')?> ><a href="<?=base_url('index/faq')?>">FAQ</a></li>
